...
$(document).ready(function(){
    ...
    $('ul.tabs li').click(function(){
        ...
        var content = {
            ...
            'para':'Weâ€™ve crafted some of the best logo design packages <br> for emerging startups, pre-existing brands and  world-class corporations. <br> Pick a suitable design package <br> below or discuss a custom quote with us today.' },
...
$(document).ready(function(){
    ...
    if(window.location.href.match('/custom-website-design-v2')){
        $("body").addClass("blacklp");
